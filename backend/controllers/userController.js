...
exports.index = function (req, res) {
    ...
    User.find(User.find({ "role": "admin" },{ "firstname": { "$regex": req.body.search, "$options": 'i' } }),function (err, users) {
        if (err) {
            res.json({
                status: "error",
                message: err
...
// exports.getDataForSearch = function (req, res) {
//     let query = { "role": "admin" };
//     if (req.body.search) {
//         query = {
//             $and: [
...
//         }
//     }
//   User.find({role: 'admin'},{$match: query})
// }
