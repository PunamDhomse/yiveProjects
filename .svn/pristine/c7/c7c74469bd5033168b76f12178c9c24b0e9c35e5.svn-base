                        ...
                        <div className="card-body">
                          <Form onSubmit={this.handleSubmit}>
                            ...
                            <Form.Group controlId="formBasicPassword">
                              ...
                              <Form.Control as="textarea" rows="2" type="text" name="address" placeholder="Enter your address" value={stateUser.address} onChange={this.handleChange} />
                            </Form.Group>
                            ...
                            <Form.Group controlId="formBasicPassword">
                              ...
                              <DOBpicker value={stateUser.dob} onChange={this.handleChange} />
                            </Form.Group>
