...
class UsersPage extends React.Component {
  ...
  componentDidMount() {
     //this.props.getUsers();
     this.props.getUserForSearch('all','', { search: this.state.searchText }).then( users => {
...
function mapState(state) {
  ...
  return { users, alert, authentication };

}

const actionCreators = {
  getUsers: userActions.getAll,
  getUserForSearch : userActions.getUsersForSearch,
