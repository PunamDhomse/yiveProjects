...
class CustomerPage extends React.Component {
  ...
  componentDidMount() {
    ...
    if (authUser && authUser.role == 'businessOwner') {
      ...
      debugger;
      this.props.getAllCustomers('location_id', authUser.location_id, { search: this.state.searchText, business_id: authUser.userprofileData.business_id }).then(customers => {
        this.setState({ customers: customers.data, main: customers.data })
      });
  ...
  render() {
    ...
    this.state.customers.forEach((customer, index) => {
      ...
      const data = {
        ...
        location: location && location.name ? location.name : 'un-assigned',
          ...
          <div className="users">
            <div className="container-fluid">
              ...
              <div className="row">
                ...
                <div className="col-sm-2 col-12 d-flex justify-content-end align-items-center">
                  {/* <Link to="/addcustomer" className="btn btn-primary w-100z editBtn text-white font-weight-normal">Add New Member</Link> */}
                  <button onClick={() => this.setState({ memberModal: true })} className="btn btn-success w-100 editBtn  font-weight-normal">ADD NEW MEMBER</button>
                </div>
