        ...
        return (
            <div className="card-body">
                ...
                <div className="d-flex justify-content-end">
                    <Button onClick={() => { this.setState({ addModal: true }) }} variant="primary">
                    {/* this.props.getBusinessById(this.props.customer.business_id); this.props.getBusinessLocations(this.props.customer.business_id); */}
                        Add New Photo
                                   </Button>
                </div>
                {/* {alert(this.props.customer.location_id)} */}
